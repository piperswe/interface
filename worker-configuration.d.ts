/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8e914dde92cfd345d51bd589a9efcbef)
// Runtime types generated with workerd@1.20260430.1 2026-04-22 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ConversationDurableObject";
	}
	interface Env {
		DB: D1Database;
		ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENROUTER_KEY">> {}
}
