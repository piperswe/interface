	...
	{#if selectedFile}
		<div class="file-viewer flex-shrink-0 border-top">
			<div class="file-viewer-header d-flex align-items-center justify-content-between px-2 py-1 border-bottom small">
				...
				<button type="button" class="btn btn-sm btn-ghost d-inline-flex align-items-center" onclick={() => { selectedFile = null; fileContent = null; }} aria-label="Close file viewer" title="Close"><X size={14} aria-hidden="true" /></button>
			</div>
