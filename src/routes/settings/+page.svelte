...
<div class="settings-layout d-flex flex-column flex-fill min-h-0">
	<div class="settings-scroll flex-fill overflow-auto">
		<div class="settings-column d-flex flex-column gap-4 mx-auto w-100">
